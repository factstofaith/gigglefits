...
function toBeUpdatedWithin(received, expected) {
    ...
    const message = () => {
        return [
            jestMatcherUtils.matcherHint('toBeUpdatedWithin', undefined, undefined, {
                isNot: this.isNot,
            }),
...
function toBeMountedWithin(received, expected) {
    ...
    const message = () => {
        return [
            jestMatcherUtils.matcherHint('toBeMountedWithin', undefined, undefined, {
                isNot: this.isNot,
            }),
            `Expected: ${expected}`,
...
function toBeRenderedTimes(received, expected) {
    ...
    const message = () => {
        return [
            jestMatcherUtils.matcherHint('toBeRenderedTimes', undefined, undefined, {
                isNot: this.isNot,
            }),
            `Expected: ${expected}`,
