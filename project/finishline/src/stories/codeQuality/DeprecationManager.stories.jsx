...
import DeprecationManager from '../components/codeQuality/DeprecationManager';

export default {
  title: 'Code Quality/DeprecationManager',
  component: DeprecationManager,
  argTypes: {
    // Control definitions will be added during enhancement
  },
} as Meta;

const Template: Story = (args) => <DeprecationManager {...args} />;
