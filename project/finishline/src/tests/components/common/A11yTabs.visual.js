/**
 * A11yTabs Visual Tests
 * 
 * Visual regression tests for the A11yTabs component.
...
describe('A11yTabs Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yTabs',
      'http://localhost:6006/iframe.html?id=components-common-a11ytabs',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yTabs',
      'http://localhost:6006/iframe.html?id=components-common-a11ytabs&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yTabs',
      'http://localhost:6006/iframe.html?id=components-common-a11ytabs&theme=dark'
    );
