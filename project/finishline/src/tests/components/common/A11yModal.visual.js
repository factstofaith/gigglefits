/**
 * A11yModal Visual Tests
 * 
 * Visual regression tests for the A11yModal component.
...
describe('A11yModal Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yModal',
      'http://localhost:6006/iframe.html?id=components-common-a11ymodal',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yModal',
      'http://localhost:6006/iframe.html?id=components-common-a11ymodal&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yModal',
      'http://localhost:6006/iframe.html?id=components-common-a11ymodal&theme=dark'
    );
