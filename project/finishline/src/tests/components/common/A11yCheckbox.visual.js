/**
 * A11yCheckbox Visual Tests
 * 
 * Visual regression tests for the A11yCheckbox component.
...
describe('A11yCheckbox Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yCheckbox',
      'http://localhost:6006/iframe.html?id=components-common-a11ycheckbox',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yCheckbox',
      'http://localhost:6006/iframe.html?id=components-common-a11ycheckbox&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yCheckbox',
      'http://localhost:6006/iframe.html?id=components-common-a11ycheckbox&theme=dark'
    );
