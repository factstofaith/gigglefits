/**
 * A11yForm Visual Tests
 * 
 * Visual regression tests for the A11yForm component.
...
describe('A11yForm Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yForm',
      'http://localhost:6006/iframe.html?id=components-common-a11yform',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yForm',
      'http://localhost:6006/iframe.html?id=components-common-a11yform&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yForm',
      'http://localhost:6006/iframe.html?id=components-common-a11yform&theme=dark'
    );
