/**
 * A11ySelect Visual Tests
 * 
 * Visual regression tests for the A11ySelect component.
...
describe('A11ySelect Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11ySelect',
      'http://localhost:6006/iframe.html?id=components-common-a11yselect',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11ySelect',
      'http://localhost:6006/iframe.html?id=components-common-a11yselect&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11ySelect',
      'http://localhost:6006/iframe.html?id=components-common-a11yselect&theme=dark'
    );
