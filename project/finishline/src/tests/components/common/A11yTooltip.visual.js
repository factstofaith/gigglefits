/**
 * A11yTooltip Visual Tests
 * 
 * Visual regression tests for the A11yTooltip component.
...
describe('A11yTooltip Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yTooltip',
      'http://localhost:6006/iframe.html?id=components-common-a11ytooltip',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yTooltip',
      'http://localhost:6006/iframe.html?id=components-common-a11ytooltip&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yTooltip',
      'http://localhost:6006/iframe.html?id=components-common-a11ytooltip&theme=dark'
    );
