/**
 * A11yRadio Visual Tests
 * 
 * Visual regression tests for the A11yRadio component.
...
describe('A11yRadio Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yRadio',
      'http://localhost:6006/iframe.html?id=components-common-a11yradio',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yRadio',
      'http://localhost:6006/iframe.html?id=components-common-a11yradio&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yRadio',
      'http://localhost:6006/iframe.html?id=components-common-a11yradio&theme=dark'
    );
