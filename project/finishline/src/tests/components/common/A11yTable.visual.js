/**
 * A11yTable Visual Tests
 * 
 * Visual regression tests for the A11yTable component.
...
describe('A11yTable Visual Tests', () => {
  let visualTesting;
  ...
  test('renders correctly in all states', async () => {
    ...
    const results = await visualTesting.testComponentStates(
      'A11yTable',
      'http://localhost:6006/iframe.html?id=components-common-a11ytable',
      states
    );
  ...
  test('renders with different themes', async () => {
    ...
    const lightResults = await visualTesting.runTestAllViewports(
      'light-theme',
      'A11yTable',
      'http://localhost:6006/iframe.html?id=components-common-a11ytable&theme=light'
    );
    ...
    const darkResults = await visualTesting.runTestAllViewports(
      'dark-theme',
      'A11yTable',
      'http://localhost:6006/iframe.html?id=components-common-a11ytable&theme=dark'
    );
