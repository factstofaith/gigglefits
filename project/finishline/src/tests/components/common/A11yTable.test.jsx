 ...
 * A11yTable Tests
 * 
 * Tests for the A11yTable component.
...
describe('A11yTable Component', () => {
  // Basic rendering tests
  describe('Rendering', () => {
    test('renders correctly with default props', () => {
      render(<A11yTable>Test Content</A11yTable>);
  ...
  describe('Accessibility', () => {
    test('meets WCAG standards', async () => {
      const results = await testA11y(<A11yTable>Accessible Content</A11yTable>);
      expect(results.violations.length).toBe(0);
    });
    
    test('supports keyboard navigation', () => {
      render(<A11yTable>Keyboard Navigable</A11yTable>);
  ...
  describe('Behavior', () => {
    test('handles user interactions correctly', async () => {
      ...
      render(
        <A11yTable onClick={handleAction}>
          Interactive Content
        </A11yTable>
      );
