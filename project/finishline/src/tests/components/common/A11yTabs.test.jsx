 ...
 * A11yTabs Tests
 * 
 * Tests for the A11yTabs component.
...
describe('A11yTabs Component', () => {
  // Basic rendering tests
  describe('Rendering', () => {
    test('renders correctly with default props', () => {
      render(<A11yTabs>Test Content</A11yTabs>);
  ...
  describe('Accessibility', () => {
    test('meets WCAG standards', async () => {
      const results = await testA11y(<A11yTabs>Accessible Content</A11yTabs>);
      expect(results.violations.length).toBe(0);
    });
    
    test('supports keyboard navigation', () => {
      render(<A11yTabs>Keyboard Navigable</A11yTabs>);
