/**
 * differential Webpack Config
 * 
 * Webpack configuration for differential loading based on browser capabilities.
 */
 ...
 */
module.exports = function differential(baseConfig, options = {}) {
