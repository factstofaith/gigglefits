...
const SEO = ({
  ...
  const fullCanonical = canonical /* WARNING: Nested ternary, consider refactoring for readability */ /* WARNING: Nested ternary, consider refactoring for readability */ /* WARNING: Nested ternary, consider refactoring for readability */ ? canonical : typeof window !== 'undefined' ? window.location.href : '';
