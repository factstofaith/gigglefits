"""
EntityRelationshipDiagram Model
...
class EntityRelationshipDiagram(Base):
    """Automated ERD generation for database models"""
    __tablename__ = "entityrelationshipdiagrams"
    ...
    @declared_attr
    def tenant(cls):
        return relationship("Tenant", back_populates="entityrelationshipdiagrams")
    
    # Add additional fields and relationships as needed
    # ...
    
    def __repr__(self):
        return f"<EntityRelationshipDiagram id={self.id}, name={self.name}>"
