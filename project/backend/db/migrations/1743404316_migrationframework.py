...
def upgrade():
    """
    Creates tables and relationships for the MigrationFramework component.
    """
    # Create tables
    op.create_table(
        'migrationframework',
...
def downgrade():
    ...
    """
    op.drop_table('migrationframework')
