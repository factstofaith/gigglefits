"""
Tests for APIRequestLogger

Unit tests for the Detailed API request logging with performance metrics
"""
import pytest
import logging
import time
...
from api.performance.apirequestlogger import APIRequestLogger

class TestAPIRequestLogger:
    """Test cases for APIRequestLogger service"""
    ...
    def service(self):
        ...
        return APIRequestLogger(config)
    
    def test_initialization(self):
        """Test service initialization"""
        service = APIRequestLogger()
        ...
        assert metrics['component'] == 'APIRequestLogger'
