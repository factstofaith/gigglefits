...
Unit tests for the Response streaming for large datasets with backpressure handling
"""
import pytest
import logging
import time
...
from api.performance.streamingresponsehandler import StreamingResponseHandler

class TestStreamingResponseHandler:
    """Test cases for StreamingResponseHandler middleware"""
    ...
    def middleware(self, app):
        ...
        return StreamingResponseHandler(app, config)
    
    def test_initialization(self, app):
        """Test middleware initialization"""
        middleware = StreamingResponseHandler(app)
        ...
        assert metrics['component'] == 'StreamingResponseHandler'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = StreamingResponseHandler(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = StreamingResponseHandler(app, {'enabled': True})
