"""
Tests for ResponseCompression

Unit tests for the Middleware for automatic response compression with configurable thresholds
"""
import pytest
import logging
import time
...
class TestResponseCompression:
    """Test cases for ResponseCompression middleware"""
    ...
    def middleware(self, app):
        ...
        return ResponseCompression(app, config)
    
    def test_initialization(self, app):
        """Test middleware initialization"""
        middleware = ResponseCompression(app)
        ...
        assert metrics['component'] == 'ResponseCompression'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = ResponseCompression(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = ResponseCompression(app, {'enabled': True})
