"""
Tests for AsyncRequestHandler

Unit tests for the Asynchronous request handling with WebSockets for real-time updates
"""
import pytest
import logging
import time
...
from api.performance.asyncrequesthandler import AsyncRequestHandler

class TestAsyncRequestHandler:
    """Test cases for AsyncRequestHandler middleware"""
    ...
    def middleware(self, app):
        ...
        return AsyncRequestHandler(app, config)
    
    def test_initialization(self, app):
        """Test middleware initialization"""
        middleware = AsyncRequestHandler(app)
        ...
        assert metrics['component'] == 'AsyncRequestHandler'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = AsyncRequestHandler(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = AsyncRequestHandler(app, {'enabled': True})
