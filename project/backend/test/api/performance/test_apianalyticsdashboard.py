"""
Tests for APIAnalyticsDashboard

Unit tests for the API usage analytics dashboard with visualization
"""
import pytest
import logging
import time
...
from api.performance.apianalyticsdashboard import APIAnalyticsDashboard

class TestAPIAnalyticsDashboard:
    """Test cases for APIAnalyticsDashboard service"""
    ...
    def service(self):
        ...
        return APIAnalyticsDashboard(config)
    
    def test_initialization(self):
        """Test service initialization"""
        service = APIAnalyticsDashboard()
        ...
        assert metrics['component'] == 'APIAnalyticsDashboard'
