"""
Tests for QueryOptimizationMiddleware

Unit tests for the Middleware for optimizing query parameters and execution plans
"""
import pytest
import logging
import time
...
from api.performance.queryoptimizationmiddleware import QueryOptimizationMiddleware

class TestQueryOptimizationMiddleware:
    """Test cases for QueryOptimizationMiddleware middleware"""
    ...
    def middleware(self, app):
        ...
        return QueryOptimizationMiddleware(app, config)
    
    def test_initialization(self, app):
        """Test middleware initialization"""
        middleware = QueryOptimizationMiddleware(app)
        ...
        assert metrics['component'] == 'QueryOptimizationMiddleware'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = QueryOptimizationMiddleware(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = QueryOptimizationMiddleware(app, {'enabled': True})
