...
Unit tests for the Advanced HTTP caching with ETags and conditional request support
"""
import pytest
import logging
import time
...
class TestCacheManager:
    """Test cases for CacheManager middleware"""
    ...
    def test_initialization(self, app):
        ...
        assert metrics['component'] == 'CacheManager'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = CacheManager(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = CacheManager(app, {'enabled': True})
