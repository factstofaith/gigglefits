"""
Tests for BatchRequestProcessor

Unit tests for the Batch request processing for multiple operations in a single request
"""
import pytest
import logging
import time
...
from api.performance.batchrequestprocessor import BatchRequestProcessor

class TestBatchRequestProcessor:
    """Test cases for BatchRequestProcessor middleware"""
    ...
    def middleware(self, app):
        ...
        return BatchRequestProcessor(app, config)
    
    def test_initialization(self, app):
        """Test middleware initialization"""
        middleware = BatchRequestProcessor(app)
        ...
        assert metrics['component'] == 'BatchRequestProcessor'
    ...
    def test_middleware_disabled(self, app):
        ...
        middleware = BatchRequestProcessor(app, {'enabled': False})
    ...
    def test_error_handling(self, app):
        ...
        middleware = BatchRequestProcessor(app, {'enabled': True})
