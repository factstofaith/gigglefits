...
class ResponseCompression:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"ResponseCompression middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize ResponseCompression middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in ResponseCompression middleware: {str(e)}")
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"ResponseCompression middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"ResponseCompression middleware disabled")
