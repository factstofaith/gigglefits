...
class CacheManager:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"CacheManager middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize CacheManager middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in CacheManager middleware: {str(e)}")
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"CacheManager middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"CacheManager middleware disabled")
