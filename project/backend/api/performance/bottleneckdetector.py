...
class BottleneckDetector:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"BottleneckDetector service initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize BottleneckDetector service: {str(e)}")
    ...
    def enable(self):
        ...
        with self._lock:
            self.enabled = True
        logger.info(f"BottleneckDetector service enabled")
    
    def disable(self):
        """Disable the service."""
        with self._lock:
            self.enabled = False
        logger.info(f"BottleneckDetector service disabled")
    ...
    def reset_metrics(self):
        ...
        logger.info(f"BottleneckDetector metrics reset")
