...
class PartialResponseHandler:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"PartialResponseHandler middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize PartialResponseHandler middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in PartialResponseHandler middleware: {str(e)}")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            'component': 'PartialResponseHandler',
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"PartialResponseHandler middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"PartialResponseHandler middleware disabled")
