...
class AsyncRequestHandler:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"AsyncRequestHandler middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize AsyncRequestHandler middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in AsyncRequestHandler middleware: {str(e)}")
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"AsyncRequestHandler middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"AsyncRequestHandler middleware disabled")
