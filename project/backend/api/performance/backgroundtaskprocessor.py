...
class BackgroundTaskProcessor:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"BackgroundTaskProcessor service initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize BackgroundTaskProcessor service: {str(e)}")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            metrics_copy = {
                'component': 'BackgroundTaskProcessor',
    ...
    def enable(self):
        ...
        with self._lock:
            self.enabled = True
        logger.info(f"BackgroundTaskProcessor service enabled")
    
    def disable(self):
        """Disable the service."""
        with self._lock:
            self.enabled = False
        logger.info(f"BackgroundTaskProcessor service disabled")
    ...
    def reset_metrics(self):
        ...
        logger.info(f"BackgroundTaskProcessor metrics reset")
