...
class APIRequestLogger:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"APIRequestLogger service initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize APIRequestLogger service: {str(e)}")
    ...
    def enable(self):
        ...
        with self._lock:
            self.enabled = True
        logger.info(f"APIRequestLogger service enabled")
    
    def disable(self):
        """Disable the service."""
        with self._lock:
            self.enabled = False
        logger.info(f"APIRequestLogger service disabled")
    ...
    def reset_metrics(self):
        ...
        logger.info(f"APIRequestLogger metrics reset")
