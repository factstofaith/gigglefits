...
class BatchRequestProcessor:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"BatchRequestProcessor middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize BatchRequestProcessor middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in BatchRequestProcessor middleware: {str(e)}")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            'component': 'BatchRequestProcessor',
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"BatchRequestProcessor middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"BatchRequestProcessor middleware disabled")
