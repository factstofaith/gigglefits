...
class QueryOptimizationMiddleware:
    ...
    def _initialize(self):
        ...
        try:
            ...
            logger.info(f"QueryOptimizationMiddleware middleware initialized")
        except Exception as e:
            self.last_error = str(e)
            logger.error(f"Failed to initialize QueryOptimizationMiddleware middleware: {str(e)}")
    ...
    async def _dispatch(
        ...
        try:
            ...
            logger.error(f"Error in QueryOptimizationMiddleware middleware: {str(e)}")
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            'component': 'QueryOptimizationMiddleware',
    ...
    def enable(self):
        ...
        self.enabled = True
        logger.info(f"QueryOptimizationMiddleware middleware enabled")
    
    def disable(self):
        """Disable the middleware."""
        self.enabled = False
        logger.info(f"QueryOptimizationMiddleware middleware disabled")
