...
export {
  ...
  createOptimizedValues,
  withRenderTiming,
  optimizeListRendering,
  DeferredRender,
  withDebouncedRendering
...
export {
  default as withRenderTracking,
  enableRenderTracking,
  disableRenderTracking,
  printRenderStats,
  resetRenderStats
} from './withRenderTracking';
...
export const initializePerformanceMonitoring = (options = {}) => {
  ...
  if (trackBundleSize && process.env.NODE_ENV === 'development') {
    enableBundleSizeTracking();
  }
