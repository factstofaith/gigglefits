...
'../../error-handling';import React from 'react';import { Container, Typography, Box, Paper, Tabs, Tab } from '../design-system/optimized'; /**
 * Earnings Page - Manages earnings codes and mappings
 */const EarningsPage = () => {const [activeTab, setActiveTab] = React.useState(0);
