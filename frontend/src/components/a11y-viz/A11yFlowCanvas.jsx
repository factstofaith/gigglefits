/**
 * A11yFlowCanvas - Accessible flow visualization
 * 
 * An accessibility-enhanced version of the FlowCanvas component that provides:
 * - Keyboard navigation of flow elements
...
/**
 * Accessibility-enhanced flow visualization component
 * 
 * @param {Object} props - Component props 
 * @returns {JSX.Element} Rendered component
 */
const A11yFlowCanvas = (props) => {
...
`;
  ...
  useEffect(() => {
    if (vizData && accessibilityLabel) {
      const summary = accessibilitySummary || `flow with ${Object.keys(vizData).length} elements`;
  ...
  return (
    <div
      ...
      aria-label={accessibilityLabel || `flow visualization`}
