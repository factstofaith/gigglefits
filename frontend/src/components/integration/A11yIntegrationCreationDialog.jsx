 ...
 */
const A11yIntegrationCreationDialog = ({ open, onClose, onSubmit }) => {
  ...
  const dialogActions = (
    <>
      <A11yButton 
        onClick={handleClose}
        a11yLabel="Cancel integration creation"
        a11yAnnouncement="Cancelling integration creation"
      >
        Cancel
      </A11yButton>
      ...
      {activeStep > 0 && (
        <A11yButton 
          ...
          a11yAnnouncement={`Going back to ${steps[activeStep - 1]}`}
        >
          Back
        </A11yButton>
      )}
      ...
      {activeStep < steps.length - 1 && (
        <A11yButton 
          ...
          a11yLabel="Continue to next step"
          a11yAnnouncement={
            activeStep === 0 && !(formik.values.name && formik.values.type && !formik.errors.name && !formik.errors.description)
              ? "Form has errors that need to be fixed before continuing"
      ...
      {activeStep === steps.length - 1 && (
        <A11yButton 
          ...
          variant="contained"
          color="primary"
          a11yLabel="Create integration"
          a11yAnnouncement="Integration created successfully"
        >
          Create Integration
        </A11yButton>
      )}
  ...
  return (
    <A11yDialog 
      ...
      fullWidth
      maxWidth="md"
      a11yLabelledBy="integration-creation-title"
      a11yDescribedBy="integration-dialog-description"
      a11yAnnouncement="Integration creation dialog opened"
    >
      <Box id="integration-dialog-description" sx={{ mb: 2 }}>
        ...
        {activeStep === 0 && (
          <Box>
            <TextField
              ...
              aria-required="true"
              {...getFieldAttributes('name', 'Integration Name')}
            />
            ...
            <TextField
              ...
              {...getFieldAttributes('description', 'Description')}
            />
            ...
            >
              ...
              <Select
                ...
                aria-required="true"
                {...getFieldAttributes('type', 'Integration Type')}
              >
              ...
              {formik.touched.type && formik.errors.type && (
                <FormHelperText id="type-error">{formik.errors.type}</FormHelperText>
              )}
            </FormControl>
          ...
          <Box>
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                label="Schedule Type"
                {...getFieldAttributes('scheduleType', 'Schedule Type')}
              >
            ...
            {formik.values.scheduleType === 'scheduled' && (
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  label="Frequency"
                  {...getFieldAttributes('scheduleFrequency', 'Frequency')}
                >
