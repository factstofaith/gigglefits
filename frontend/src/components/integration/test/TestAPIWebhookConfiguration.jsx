  ...
  return <Container maxWidth="lg" sx={{
    py: 4
      ...
      mb: 4
        ...
        <CardContent>
          ...
          mb: 2
            ...
            <FormControlLabel control={<Switch checked={readOnly} onChange={e => setReadOnly(e.target.checked)} />} label="Read Only Mode" />
      ...
      display: activeTab === 0 ? 'block' : 'none'
        ...
        <APISourceConfiguration value={apiConfig} onChange={setApiConfig} onTest={handleTestApi} disabled={readOnly} />
      ...
      display: activeTab === 1 ? 'block' : 'none'
        ...
        <WebhookConfiguration value={webhookConfig} onChange={setWebhookConfig} onTest={handleTestWebhook} disabled={readOnly} />
