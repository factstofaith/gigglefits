...
import { Box, Button, Card, CardContent, Container, Divider, Paper, Typography, Switch, FormControlLabel } from '@mui/material';
  ...
  return <Container maxWidth="lg" sx={{
    py: 4
      ...
      mb: 4
        ...
        <SharePointConfiguration value={config} onChange={setConfig} readOnly={readOnly} />
