      ...
      display: 'flex'
        ...
        height: '100%'
          ...
          height: '100%'
            ...
            <NodePanel userPermissions={userPermissions} onRefresh={() => {}} // Placeholder for refresh functionality
          />
          </Grid>
          ...
          height: '100%'
            ...
            overflow: 'hidden'
              ...
              <FlowCanvas initialElements={elements} readOnly={readOnly} onChange={handleElementsChange} onSave={handleSave} onNodeSelect={handleNodeSelect} onEdgeSelect={handleEdgeSelect} onValidate={handleValidate} validationErrors={validationErrors} />
            ...
            overflow: 'hidden'
              ...
              overflow: 'auto'
                ...
                p: 2
                    ...
                    {Object.keys(validationErrors).length > 0 && <Box sx={{
                  color: 'error.main',
                  mt: 2
                }}>
                        <h4>Validation Errors</h4>
                        {Object.entries(validationErrors).map(([key, error]) => <p key={key}>{error}</p>)}

                      </Box>}

                  </Box> : renderNodeProperties()}
              </Box>
            </Paper>
          </Grid>
        </Grid>
