...
import { Storage as StorageIcon, CloudUpload as CloudUploadIcon, Storage as DatabaseIcon,
// Use Storage icon as a replacement for Database
Api as ApiIcon, Settings as SettingsIcon, Error as ErrorIcon, Check as CheckIcon } from '@mui/icons-material';
  ...
  return <Paper elevation={selected ? 3 : 1} sx={{
    ...
    position: 'relative'
      ...
      borderTopRightRadius: 4
        ...
        <DestinationIconComponent fontSize="small" sx={{
        mr: 1
      }} />
...
export default withErrorBoundary(DestinationNode, {
  boundary: 'DestinationNode'
});