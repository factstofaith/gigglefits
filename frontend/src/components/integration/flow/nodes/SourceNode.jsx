...
import { Storage as StorageIcon, Settings as SettingsIcon, Error as ErrorIcon, Check as CheckIcon } from '@mui/icons-material';
const SOURCE_TYPES = {
  S3: {
    icon: StorageIcon,
    color: '#ff9900',
  ...
  return <Paper elevation={selected ? 3 : 1} sx={{
    ...
    position: 'relative'
      ...
      borderTopRightRadius: 4
        ...
        <SourceIconComponent fontSize="small" sx={{
        mr: 1
      }} />
...
export default withErrorBoundary(SourceNode, {
  boundary: 'SourceNode'
});