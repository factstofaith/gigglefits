 ...
 */
const FileTypeCard = ({ result, compact = false }) => {
  const { detectedType, confidence, possibleTypes, metadata } = result;
    ...
    <Card variant="outlined">
      <CardContent>
        <Grid container spacing={2} alignItems="center">
          <Grid item>
            <Badge
              badgeContent={`${formatConfidence(confidence)}`}
          ...
          <Grid item xs>
            ...
            <Stack direction="row" spacing={1} sx={{ mt: 0.5 }}>
              <Chip 
                label={detectedType.category} 
                size="small" 
                variant="outlined"
              />
              {detectedType.isTextBased && (
                <Chip 
                  label="Text-based" 
                  size="small" 
                  variant="outlined"
            ...
            {possibleTypes && possibleTypes.length > 0 && (
              <Box sx={{ mt: 2 }}>
                ...
                <Stack direction="row" spacing={1} flexWrap="wrap">
                  {possibleTypes.map((pt, index) => (
                    <Chip 
                      key={index}
                      label={`${pt.type.name} (${formatConfidence(pt.confidence)})`} 
                      size="small"
                      variant="outlined"
                      icon={getFileTypeIconComponent(pt.type.category)}
                      sx={{ mb: 0.5 }}
                    />
                  ))}
                </Stack>
  ...
  return (
    <Paper sx={{ p: compact ? 0 : 3 }}>
      <Box>
        ...
        {!compact && showDetailedResults && selectedFile && (
          <Box sx={{ mt: 3 }}>
                    ...
                    <List dense disablePadding>
                      ...
                      <ListItem>
                        ...
                        <ListItemText 
                          ...
                          secondary={
                            <Chip 
                              label={formatConfidence(detectionResult.confidence)}
                              size="small"
                    ...
                    <List dense disablePadding>
                      <ListItem>
                        ...
                        <ListItemText 
                          ...
                          secondary={
                            <Chip 
                              label={detectionResult.detectedType.category}
                              size="small"
                              variant="outlined"
                            />
                          }
                      ...
                      <ListItem>
                        ...
                        <ListItemText 
                          ...
                          secondary={
                            <Chip 
                              label={detectionResult.detectedType.isTextBased ? 'Yes' : 'No'}
                              size="small"
                              color={detectionResult.detectedType.isTextBased ? 'success' : 'default'}
                              variant="outlined"
                            />
                          }
                          primaryTypographyProps={{ variant: 'body2' }}
