            ...
            <List dense>
              <ListItem>
                ...
                <ListItemText 
                  ...
                  secondary="CSV, TSV, JSON, XML, YAML, Parquet, Avro, ORC" 
                />
              </ListItem>
              ...
              <ListItem>
                ...
                <ListItemText 
                  primary="Documents" 
                  secondary="PDF, Word, ODT, TXT, Markdown" 
                />
              </ListItem>
                  ...
                  {detectionResult.possibleTypes && detectionResult.possibleTypes.length > 0 && (
                    <>
                      ...
                      <Stack direction="row" spacing={1} sx={{ mt: 0.5 }} flexWrap="wrap">
                        {detectionResult.possibleTypes.map((pt, index) => (
                          <Chip 
                            key={index}
                            label={`${pt.type.name} (${Math.round(pt.confidence * 100)}%)`} 
                            size="small"
                            variant="outlined"
                            sx={{ mb: 0.5 }}
                          />
                ...
                <List dense>
                  <ListItem>
                    ...
                    <ListItemText 
                      ...
                      secondary="Examines file extensions as initial indicators" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Binary Signatures" 
                      secondary="Detects file type-specific byte patterns" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Content Inspection" 
                      secondary="Analyzes file content structure and patterns" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Deep Inspection" 
                      secondary="Performs thorough content validation for ambiguous files" 
                    />
                  </ListItem>
                </List>
              </CardContent>
                ...
                <List dense>
                  <ListItem>
                    ...
                    <ListItemText 
                      ...
                      secondary="Indicates detection reliability with numeric confidence scores" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Alternative Type Detection" 
                      secondary="Provides other possible file types when detection is ambiguous" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Detailed Metadata" 
                      secondary="Includes comprehensive information about detected file types" 
                    />
                  </ListItem>
                  ...
                  <ListItem>
                    ...
                    <ListItemText 
                      primary="Browser-based Detection" 
                      secondary="Works entirely in the browser without server-side processing" 
                    />
                  </ListItem>
                </List>
              </CardContent>
