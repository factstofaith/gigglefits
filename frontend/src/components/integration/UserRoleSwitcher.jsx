...
import { Box, Button, FormControlLabel, Radio, RadioGroup, Typography, Paper } from '@mui/material';
    ...
    bgcolor: '#f5f5f5'
      ...
      flexDirection: 'column'
        ...
        <RadioGroup row name="user-role" value={currentRole} onChange={handleRoleChange}>
          ...
          <FormControlLabel value="admin" control={<Radio size="small" />} label="Super User / Admin" />

        </RadioGroup>
        
        <Typography variant="caption" color="textSecondary">
          Current permissions: {currentRole === 'admin' ? 'Full access (can view and configure all settings)' : 'Limited access (can view but not modify system-level settings)'}
        </Typography>
      </Box>
    </Paper>;
};
