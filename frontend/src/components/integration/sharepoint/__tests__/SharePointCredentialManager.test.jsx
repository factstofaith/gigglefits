...
import SharePointCredentialManager from './SharePointCredentialManager';
...
describe('SharePointCredentialManager', () => {
  test('renders the form correctly', () => {
    render(<ErrorProvider><SharePointCredentialManager /></ErrorProvider>);
