...
import { Box, Container, Typography, Paper, Button, Grid, FormControl, InputLabel, Select, MenuItem, Divider, Alert } from '@mui/material';
...
const SAMPLE_DATASETS = {
  customers: [{
    ...
    lastLogin: '2023-05-20T14:30:45Z',
    ...
    lastLogin: '2023-05-18T09:15:30Z',
    ...
    lastLogin: '2023-03-10T11:45:20Z',
    accountBalance: 0
  }, {
    id: 4,
    firstName: 'Alice',
    ...
    lastLogin: '2023-05-21T16:20:15Z',
    accountBalance: 540.25
  }, {
    id: 5,
    firstName: 'Charlie',
    lastName: 'Brown',
    ...
    lastLogin: '2023-05-19T13:10:05Z',
    accountBalance: 75.80
  }],
  orders: [{
    orderId: 'ORD-001',
    customerId: 1,
    ...
    total: 85.25,
    items: 2,
    shippingAddress: '456 Elm St, Somewhere, USA',
    ...
    total: 210.75,
    items: 4,
    shippingAddress: '789 Oak St, Nowhere, USA',
    ...
    total: 75.80,
    items: 2,
    shippingAddress: '101 Pine St, Elsewhere, USA',
    paymentMethod: 'paypal'
  }],
  products: [{
    productId: 'P-001',
  ...
  events: [{
    ...
    type: 'purchase',
    userId: 2,
    timestamp: '2023-05-19T10:15:30Z',
    ...
    type: 'login',
    userId: 3,
    timestamp: '2023-03-10T11:45:20Z',
    ...
    type: 'login',
    userId: 4,
    timestamp: '2023-05-21T16:20:15Z',
    ...
    type: 'purchase',
    userId: 5,
    timestamp: '2023-05-18T13:10:05Z',
  ...
  return <Container maxWidth="lg" sx={{
    ...
    mb: 4
        ...
        <Grid container spacing={2} alignItems="center">
          <Grid item xs={12} md={4}>
            <FormControl fullWidth>
              ...
              <Select labelId="dataset-select-label" value={selectedDataset} label="Sample Dataset" onChange={handleDatasetChange}>
      ...
      height: 600
        ...
        <DataPreview data={data} isLoading={isLoading} dataSource={`Sample ${selectedDataset} dataset`} maxHeight={600} showDownload={true} showFilters={true} showValidation={true} showSchemaInference={true} initialViewMode="table" onSchemaInferred={handleSchemaInferred} onQualityAnalyzed={handleQualityAnalyzed} />
