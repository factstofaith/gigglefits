...
import AzureBlobContainerBrowser from './AzureBlobContainerBrowser';
...
describe('AzureBlobContainerBrowser', () => {
  test('renders the form correctly', () => {
    render(<ErrorProvider><AzureBlobContainerBrowser /></ErrorProvider>);
  ...
  test('handles submission errors correctly', async () => {
    ...
    // Submit the form
    const submitButton_1 = screen.getByRole('button', {
      name: /submit|save/i
    });
    fireEvent.click(submitButton_1);
