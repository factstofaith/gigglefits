 ...
 */
function A11yTabPanel({ children, value, index, id, ...other }) {
  return (
    <div
      role="tabpanel"
      hidden={value !== index}
 ...
 */
const A11yIntegrationDetailView = ({ integrationId }) => {
  ...
  const { containerRef } = useA11yFocus({ trapFocus: isEditing });
    ...
    return (
      ...
      >
        ...
        <A11yButton 
          ...
          a11yLabel="Reload page"
          a11yAnnouncement="Reloading page to try again"
        >
          Reload
        </A11yButton>
      </Paper>
  ...
  return (
    <Card 
      sx={{ mx: { xs: 1, sm: 2, md: 3 }, mt: { xs: 1, sm: 2 } }}
      ref={containerRef}
    >
      <CardHeader
        title={
        ...
        action={
          <Box sx={{ 
            ...
            <A11yButton
              ...
              a11yLabel="Run integration now"
              a11yAnnouncement={runningIntegration ? "Integration is running" : "Starting integration run"}
              a11yControls="integration-run-status"
            >
      ...
      <CardContent sx={{ px: { xs: 2, sm: 3 }, py: { xs: 2, sm: 3 } }}>
        ...
        <A11yTabPanel value={activeTab} index={1} id="integration">
          {isAzureBlobUsed ? (
            ...
            <Typography color="textSecondary" tabIndex={0}>
      ...
      {isEditing && (
        <Box sx={{ 
          ...
          <A11yButton 
            ...
            variant="outlined"
            a11yLabel="Cancel editing"
            a11yAnnouncement="Cancelling edit mode, no changes saved"
          >
            Cancel
          </A11yButton>
          <A11yButton 
            ...
            ref={saveButtonRef}
            a11yLabel="Save all changes"
            a11yAnnouncement={saving ? "Saving changes" : "All changes saved"}
          >
