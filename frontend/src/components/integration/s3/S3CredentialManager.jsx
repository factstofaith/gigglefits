...
const S3CredentialManager = ({
  ...
  const validateCredentials = useCallback(() => {
    switch (credentials.authMethod) {
      case 'accessKey':
        return credentials.accessKeyId.trim() !== '' && credentials.secretAccessKey.trim() !== '' && credentials.region.trim() !== '';
      case 'profile':
        return credentials.profile.trim() !== '' && credentials.region.trim() !== '';
      case 'iamRole':
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={showAccessKey ? 6 : 12}>
              <FormControl fullWidth>
                ...
                <Select labelId="region-label" id="region" name="region" value={credentials.region} onChange={handleChange} label="AWS Region" disabled={loading || readOnly}>
            ...
            {showAccessKey && <>
                <Grid item xs={12} md={6}>
                  <FormControl fullWidth>
                    <TextField name="accessKeyId" label="Access Key ID" value={credentials.accessKeyId} onChange={handleChange} disabled={loading || readOnly} />
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth>
                    <TextField name="secretAccessKey" label="Secret Access Key" value={credentials.secretAccessKey} onChange={handleChange} type={showSecrets ? 'text' : 'password'} disabled={loading || readOnly} InputProps={{
            ...
            {showProfile && <Grid item xs={12}>
                <FormControl fullWidth>
                  <TextField name="profile" label="AWS Profile Name" value={credentials.profile} onChange={handleChange} disabled={loading || readOnly} InputProps={{
                endAdornment: <InputAdornment position="end">
            ...
            {/* IAM Role */}
            {credentials.authMethod === 'iamRole' && <Grid item xs={12}>
            ...
            mt: 2
              ...
              mt: 2
                ...
                mb: 2
                  ...
                  <TextField name="assumeRoleArn" label="Assume Role ARN (Optional)" value={credentials.assumeRoleArn} onChange={handleChange} disabled={loading || readOnly} InputProps={{
                  endAdornment: <InputAdornment position="end">
                ...
                {showAssumeRole && <FormControl fullWidth>
                    <TextField name="externalId" label="External ID (Optional)" value={credentials.externalId} onChange={handleChange} disabled={loading || readOnly} />
          ...
          mt: 3
            ...
            mb: 2
              ...
              mt: 1
                      ...
                      {testResult.success ? <>
                          {testResult.details.buckets && <Typography variant="body2">
                              Found {testResult.details.buckets} bucket(s)
                            </Typography>}

                          {testResult.details.region && <Typography variant="body2">
